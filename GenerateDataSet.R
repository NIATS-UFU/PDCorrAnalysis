...
dataSet <- lapply(file.name.v,buildDataSet, processData=TRUE)
...
sensors <- c("X.G1.X.", "X.G1.Y." , "X.G1.Z." ,  "X.G2.X.",  "X.G2.Y.",  "X.G2.Z.",
             "X.A1.X.", "X.A1.Y." ,"X.A1.Z."  ,  "X.A2.X.",  "X.A2.Y.",  "X.A2.Z.",
             "X.M1.X.", "X.M1.Y." ,"X.M1.Z." ,    "X.M2.X.", "X.M2.Y.",  "X.M2.Z.")
